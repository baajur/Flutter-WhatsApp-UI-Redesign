...
class NewCallSelectContactAllContacts extends StatelessWidget {
  NewCallSelectContactAllContacts(this.all_contacts, this.status);
    ...
    return GestureDetector(
      ...
      child: Row(
        children: [
          ...
          Row(children: <Widget>[
            IconButton(icon: Icon(Icons.videocam, color: Color(0xff35A897),), onPressed: null),
            IconButton(icon: Icon(Icons.phone, color: Color(0xff35A897)), onPressed: null),
          ],)
        ],
      ),
    ));
